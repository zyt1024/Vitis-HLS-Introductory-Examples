...
`define TV_IN_inStreamTop_TDATA "../tv/cdatafile/c.example.autotvin_inStreamTop_V_data_V.dat"
`define INGRESS_STATUS_inStreamTop_TDATA "../tv/stream_size/stream_ingress_status_inStreamTop_V_data_V.dat"
`define TV_IN_inStreamTop_TKEEP "../tv/cdatafile/c.example.autotvin_inStreamTop_V_keep_V.dat"
`define INGRESS_STATUS_inStreamTop_TKEEP "../tv/stream_size/stream_ingress_status_inStreamTop_V_keep_V.dat"
`define TV_IN_inStreamTop_TSTRB "../tv/cdatafile/c.example.autotvin_inStreamTop_V_strb_V.dat"
`define INGRESS_STATUS_inStreamTop_TSTRB "../tv/stream_size/stream_ingress_status_inStreamTop_V_strb_V.dat"
`define TV_IN_inStreamTop_TLAST "../tv/cdatafile/c.example.autotvin_inStreamTop_V_last_V.dat"
...
module AESL_axi_s_inStreamTop (
    input clk,
    input reset,
    output [64 - 1:0] TRAN_inStreamTop_TDATA,
    output [8 - 1:0] TRAN_inStreamTop_TKEEP,
    output [8 - 1:0] TRAN_inStreamTop_TSTRB,
    ...
    reg [64 - 1:0] inStreamTop_TDATA_write_data;
    reg inStreamTop_TDATA_read_en;
    wire [64 - 1:0] inStreamTop_TDATA_read_data;
    
    fifo #(1024, 64) fifo_inStreamTop_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [8 - 1:0] inStreamTop_TKEEP_write_data;
    reg inStreamTop_TKEEP_read_en;
    wire [8 - 1:0] inStreamTop_TKEEP_read_data;
    
    fifo #(1024, 8) fifo_inStreamTop_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [8 - 1:0] inStreamTop_TSTRB_write_data;
    reg inStreamTop_TSTRB_read_en;
    wire [8 - 1:0] inStreamTop_TSTRB_read_data;
    
    fifo #(1024, 8) fifo_inStreamTop_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1024, 1) fifo_inStreamTop_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_inStreamTop_TVALID_temp = ~(inStreamTop_TDATA_empty || inStreamTop_TKEEP_empty || inStreamTop_TSTRB_empty || inStreamTop_TLAST_empty);
