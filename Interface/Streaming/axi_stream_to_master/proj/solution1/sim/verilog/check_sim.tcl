...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.example.autotvin_inStreamTop_V_data_V.dat"
         "c.example.autotvin_inStreamTop_V_keep_V.dat"
         "c.example.autotvin_inStreamTop_V_strb_V.dat"
         "c.example.autotvin_inStreamTop_V_last_V.dat"
         "c.example.autotvin_outTop.dat"
         "c.example.autotvout_gmem0.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.example.autotvout_gmem0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
