...
`define AUTOTB_TVIN_inStreamTop_V_data_V  "./c.example.autotvin_inStreamTop_V_data_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_keep_V  "./c.example.autotvin_inStreamTop_V_keep_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_strb_V  "./c.example.autotvin_inStreamTop_V_strb_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_last_V  "./c.example.autotvin_inStreamTop_V_last_V.dat"
`define AUTOTB_TVIN_outTop  "./c.example.autotvin_outTop.dat"
`define AUTOTB_TVIN_inStreamTop_V_data_V_out_wrapc  "./rtl.example.autotvin_inStreamTop_V_data_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_keep_V_out_wrapc  "./rtl.example.autotvin_inStreamTop_V_keep_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_strb_V_out_wrapc  "./rtl.example.autotvin_inStreamTop_V_strb_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_last_V_out_wrapc  "./rtl.example.autotvin_inStreamTop_V_last_V.dat"
`define AUTOTB_TVIN_outTop_out_wrapc  "./rtl.example.autotvin_outTop.dat"
`define AUTOTB_TVOUT_gmem0  "./c.example.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_gmem0_out_wrapc  "./impl_rtl.example.autotvout_gmem0.dat"
module `AUTOTB_TOP;
