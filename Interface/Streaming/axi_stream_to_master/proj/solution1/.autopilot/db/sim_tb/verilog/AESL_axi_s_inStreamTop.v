...
`define TV_IN_inStreamTop_TDATA "./c.example.autotvin_inStreamTop_V_data_V.dat"
`define INGRESS_STATUS_inStreamTop_TDATA "./stream_ingress_status_inStreamTop_V_data_V.dat"
`define TV_IN_inStreamTop_TKEEP "./c.example.autotvin_inStreamTop_V_keep_V.dat"
`define INGRESS_STATUS_inStreamTop_TKEEP "./stream_ingress_status_inStreamTop_V_keep_V.dat"
`define TV_IN_inStreamTop_TSTRB "./c.example.autotvin_inStreamTop_V_strb_V.dat"
`define INGRESS_STATUS_inStreamTop_TSTRB "./stream_ingress_status_inStreamTop_V_strb_V.dat"
`define TV_IN_inStreamTop_TLAST "./c.example.autotvin_inStreamTop_V_last_V.dat"
