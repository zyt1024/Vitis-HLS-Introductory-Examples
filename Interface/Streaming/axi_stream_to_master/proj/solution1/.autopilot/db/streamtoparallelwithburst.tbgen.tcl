...
set C_modelArgList {
	{ buf_r int 128 regular {fifo 0 volatile }  }
	{ count7 int 32 regular {fifo 0 volatile }  }
	{ gmem0 int 64 regular {axi_master 1}  }
	{ p_read int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "buf_r", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "count7", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ buf_r_dout sc_in sc_lv 128 signal 0 } 
	{ buf_r_empty_n sc_in sc_logic 1 signal 0 } 
	{ buf_r_read sc_out sc_logic 1 signal 0 } 
	{ count7_dout sc_in sc_lv 32 signal 1 } 
	{ count7_empty_n sc_in sc_logic 1 signal 1 } 
	{ count7_read sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf_r_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "buf_r", "role": "dout" }} , 
 	...
 	{ "name": "count7_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "count7", "role": "dout" }} , 
 	{ "name": "count7_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "count7", "role": "empty_n" }} , 
 	{ "name": "count7_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "count7", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "buf_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4096", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_91", "Port" : "buf_r", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "count7", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_91", "Port" : "gmem0", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_91", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			...
			{"Name" : "phi_ln26_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_24_2", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_91.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}


set ArgLastReadFirstWriteLatency {
	streamtoparallelwithburst {
		buf_r {Type I LastRead 1 FirstWrite -1}
		count7 {Type I LastRead 1 FirstWrite -1}
	...
	streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2 {
		...
		buf_r {Type I LastRead 1 FirstWrite -1}
		phi_ln26_out {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	buf_r { ap_fifo {  { buf_r_dout fifo_data 0 128 }  { buf_r_empty_n fifo_status 0 1 }  { buf_r_read fifo_update 1 1 } } }
	count7 { ap_fifo {  { count7_dout fifo_data 0 32 }  { count7_empty_n fifo_status 0 1 }  { count7_read fifo_update 1 1 } } }
