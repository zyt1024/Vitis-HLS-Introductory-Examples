...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_buf_r \
    op interface \
    ports { buf_r_dout { I 128 vector } buf_r_empty_n { I 1 bit } buf_r_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_phi_ln26_out \
    op interface \
    ports { phi_ln26_out { O 1 vector } phi_ln26_out_ap_vld { O 1 bit } } \
} "
}
