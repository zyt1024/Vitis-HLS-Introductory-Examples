...
# FIFO definition: 
set ID 21
set FifoName example_fifo_w64_d2_S
set InstName outTop_c_channel_U
...
# FIFO definition: 
set ID 22
set FifoName example_fifo_w128_d4096_A
set InstName buf_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler example_gmem0_m_axi BINDTYPE interface TYPE interface_m_axi
}
